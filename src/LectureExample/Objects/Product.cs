    ...
    public class Product : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ProductE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ProductE", typeof(IIS.LectureExample.Product));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ProductL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ProductL", typeof(IIS.LectureExample.Product));
                }
            }
        }
    }
