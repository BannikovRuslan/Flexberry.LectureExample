...
define('ember-app/controllers/i-i-s-lecture-example-order-e', ['exports', 'ember-flexberry/controllers/edit-form'], function (exports, _editForm) {
  'use strict';
...
define('ember-app/controllers/i-i-s-lecture-example-order-e/new', ['exports', 'ember-app/controllers/i-i-s-lecture-example-order-e'], function (exports, _iISLectureExampleOrderE) {
  'use strict';
  ...
  var IISLectureExampleOrderENewController = _iISLectureExampleOrderE.default;
  exports.default = IISLectureExampleOrderENewController;
});
define('ember-app/controllers/i-i-s-lecture-example-order-l', ['exports', 'ember-flexberry/controllers/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @type String
      @default 'i-i-s-lecture-example-order-e'
     */
    editFormRoute: 'i-i-s-lecture-example-order-e'
  });
});
define('ember-app/controllers/i-i-s-lecture-example-product-e', ['exports', 'ember-flexberry/controllers/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    parentRoute: 'i-i-s-lecture-example-product-l'
  });
});
define('ember-app/controllers/i-i-s-lecture-example-product-e/new', ['exports', 'ember-app/controllers/i-i-s-lecture-example-product-e'], function (exports, _iISLectureExampleProductE) {
  'use strict';
  ...
  var IISLectureExampleProductENewController = _iISLectureExampleProductE.default;
  exports.default = IISLectureExampleProductENewController;
});
define('ember-app/controllers/i-i-s-lecture-example-product-l', ['exports', 'ember-flexberry/controllers/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      Name of related edit form route.
       @property editFormRoute
      @type String
      @default 'i-i-s-lecture-example-product-e'
     */
    editFormRoute: 'i-i-s-lecture-example-product-e'
  });
});
...
define('ember-app/enums/i-i-s-lecture-example-order-status', ['exports', 'ember-flexberry-data/utils/enum-functions'], function (exports, _enumFunctions) {
  'use strict';
...
define('ember-app/locales/en/forms/i-i-s-lecture-example-order-e', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = {
    ...
    'shipmentDate-caption': 'Shipment date',
    'paymentDay-caption': 'Payment day',
    'totalSum-caption': 'Total sum',
    'orderItem-caption': 'Order item'
  };
});
define('ember-app/locales/en/forms/i-i-s-lecture-example-order-l', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/forms/i-i-s-lecture-example-product-e', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = {
    caption: 'Product',
    'productCode-caption': 'Product code',
    'name-caption': 'Name',
...
define('ember-app/locales/en/forms/i-i-s-lecture-example-product-l', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-lecture-example-order-item', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-lecture-example-order', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-lecture-example-product', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/forms/i-i-s-lecture-example-order-l', 'ember-app/locales/en/forms/i-i-s-lecture-example-product-l', 'ember-app/locales/en/forms/i-i-s-lecture-example-order-e', 'ember-app/locales/en/forms/i-i-s-lecture-example-product-e', 'ember-app/locales/en/models/i-i-s-lecture-example-order-item', 'ember-app/locales/en/models/i-i-s-lecture-example-order', 'ember-app/locales/en/models/i-i-s-lecture-example-product'], function (exports, _translations, _iISLectureExampleOrderL, _iISLectureExampleProductL, _iISLectureExampleOrderE, _iISLectureExampleProductE, _iISLectureExampleOrderItem, _iISLectureExampleOrder, _iISLectureExampleProduct) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    models: {
      'i-i-s-lecture-example-order-item': _iISLectureExampleOrderItem.default,
      'i-i-s-lecture-example-order': _iISLectureExampleOrder.default,
      'i-i-s-lecture-example-product': _iISLectureExampleProduct.default
    },
    ...
    forms: {
      ...
      'i-i-s-lecture-example-order-l': _iISLectureExampleOrderL.default,
      'i-i-s-lecture-example-product-l': _iISLectureExampleProductL.default,
      'i-i-s-lecture-example-order-e': _iISLectureExampleOrderE.default,
      'i-i-s-lecture-example-product-e': _iISLectureExampleProductE.default
    }
...
define('ember-app/locales/ru/forms/i-i-s-lecture-example-order-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/forms/i-i-s-lecture-example-order-l', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/forms/i-i-s-lecture-example-product-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/forms/i-i-s-lecture-example-product-l', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-lecture-example-order-item', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-lecture-example-order', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-lecture-example-product', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/forms/i-i-s-lecture-example-order-l', 'ember-app/locales/ru/forms/i-i-s-lecture-example-product-l', 'ember-app/locales/ru/forms/i-i-s-lecture-example-order-e', 'ember-app/locales/ru/forms/i-i-s-lecture-example-product-e', 'ember-app/locales/ru/models/i-i-s-lecture-example-order-item', 'ember-app/locales/ru/models/i-i-s-lecture-example-order', 'ember-app/locales/ru/models/i-i-s-lecture-example-product'], function (exports, _translations, _iISLectureExampleOrderL, _iISLectureExampleProductL, _iISLectureExampleOrderE, _iISLectureExampleProductE, _iISLectureExampleOrderItem, _iISLectureExampleOrder, _iISLectureExampleProduct) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-lecture-example-order-item', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  'use strict';
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    priceWTaxes: _emberData.default.attr('decimal'),
    totalSum: _emberData.default.attr('decimal'),
    product: _emberData.default.belongsTo('i-i-s-lecture-example-product', { inverse: null, async: false }),
    order: _emberData.default.belongsTo('i-i-s-lecture-example-order', { inverse: 'orderItem', async: false })
  });

  var ValidationRules = exports.ValidationRules = {
    amount: {
      descriptionKey: 'models.i-i-s-lecture-example-order-item.validations.amount.__caption__',
    ...
    priceWTaxes: {
      descriptionKey: 'models.i-i-s-lecture-example-order-item.validations.priceWTaxes.__caption__',
    ...
    totalSum: {
      descriptionKey: 'models.i-i-s-lecture-example-order-item.validations.totalSum.__caption__',
      validators: [(0, _emberCpValidations.validator)('ds-error'), (0, _emberCpValidations.validator)('number', { allowString: true, allowBlank: true })]
    },
    product: {
      descriptionKey: 'models.i-i-s-lecture-example-order-item.validations.product.__caption__',
      validators: [(0, _emberCpValidations.validator)('ds-error')]
    },
    order: {
      descriptionKey: 'models.i-i-s-lecture-example-order-item.validations.order.__caption__',
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('OrderItemE', 'i-i-s-lecture-example-order-item', {
      amount: (0, _attributes.attr)('Amount', { index: 0 }),
      priceWTaxes: (0, _attributes.attr)('Price w taxes', { index: 1 }),
      totalSum: (0, _attributes.attr)('Total sum', { index: 2 }),
      product: (0, _attributes.belongsTo)('i-i-s-lecture-example-product', 'Product', {
        name: (0, _attributes.attr)('Name', { index: 4, hidden: true })
      }, { index: 3, displayMemberPath: 'name' })
    });
  };
});
define('ember-app/mixins/regenerated/models/i-i-s-lecture-example-order', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  'use strict';
  ...
  exports.defineProjections = exports.ValidationRules = exports.Model = undefined;
  var Model = exports.Model = Ember.Mixin.create({
    paymentDay: _emberData.default.attr('date'),
    shipmentDate: _emberData.default.attr('date'),
    status: _emberData.default.attr('i-i-s-lecture-example-order-status'),
    /**
      Non-stored property.
       @property totalSum
    */
    ...
    /**
      ...
      @example
        ...
        ```
    */
    _totalSumCompute: function _totalSumCompute() {
      var result = this.totalSumCompute && typeof this.totalSumCompute === 'function' ? this.totalSumCompute() : null;
      this.set('totalSum', result);
    },
    orderItem: _emberData.default.hasMany('i-i-s-lecture-example-order-item', { inverse: 'order', async: false })
  });
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('OrderE', 'i-i-s-lecture-example-order', {
      status: (0, _attributes.attr)('Status', { index: 0 }),
      shipmentDate: (0, _attributes.attr)('Shipment date', { index: 1 }),
      paymentDay: (0, _attributes.attr)('Payment day', { index: 2 }),
      totalSum: (0, _attributes.attr)('Total sum', { index: 3 }),
      orderItem: (0, _attributes.hasMany)('i-i-s-lecture-example-order-item', 'Order item', {
        amount: (0, _attributes.attr)('Amount', { index: 0 }),
        priceWTaxes: (0, _attributes.attr)('Price w taxes', { index: 1 }),
        totalSum: (0, _attributes.attr)('Total sum', { index: 2 }),
        product: (0, _attributes.belongsTo)('i-i-s-lecture-example-product', 'Product', {
...
define('ember-app/mixins/regenerated/models/i-i-s-lecture-example-product', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  'use strict';
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    measure: _emberData.default.attr('string'),
    name: _emberData.default.attr('string'),
    price: _emberData.default.attr('decimal'),
    productCode: _emberData.default.attr('number'),
    weight: _emberData.default.attr('decimal')
  });
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ProductE', 'i-i-s-lecture-example-product', {
      productCode: (0, _attributes.attr)('Product code', { index: 0 }),
      name: (0, _attributes.attr)('Name', { index: 1 }),
      measure: (0, _attributes.attr)('Measure', { index: 2 }),
      description: (0, _attributes.attr)('Description', { index: 3 }),
      price: (0, _attributes.attr)('Price', { index: 4 }),
      weight: (0, _attributes.attr)('Weight', { index: 5 })
    });
...
define('ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-order-item-offline', ['exports'], function (exports) {
  'use strict';
  ...
  var OfflineSerializer = exports.OfflineSerializer = Ember.Mixin.create({
    getAttrs: function getAttrs() {
      ...
      var attrs = {
        ...
        order: { serialize: 'id', deserialize: 'records' }
      };
...
define('ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-order-item', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-order-offline', ['exports'], function (exports) {
  'use strict';
  ...
  var OfflineSerializer = exports.OfflineSerializer = Ember.Mixin.create({
    getAttrs: function getAttrs() {
      var parentAttrs = this._super();
      var attrs = {
        orderItem: { serialize: 'ids', deserialize: 'records' }
      };
...
define('ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-order', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-product-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-product', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/i-i-s-lecture-example-order-item', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-lecture-example-order-item'], function (exports, _emberCpValidations, _model, _iISLectureExampleOrderItem) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISLectureExampleOrderItem.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISLectureExampleOrderItem.Model, Validations, {});

  (0, _iISLectureExampleOrderItem.defineProjections)(Model);

  exports.default = Model;
});
define('ember-app/models/i-i-s-lecture-example-order', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-lecture-example-order'], function (exports, _emberCpValidations, _model, _iISLectureExampleOrder) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISLectureExampleOrder.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISLectureExampleOrder.Model, Validations, {});

  (0, _iISLectureExampleOrder.defineProjections)(Model);

  exports.default = Model;
});
define('ember-app/models/i-i-s-lecture-example-product', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-lecture-example-product'], function (exports, _emberCpValidations, _model, _iISLectureExampleProduct) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISLectureExampleProduct.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISLectureExampleProduct.Model, Validations, {});

  (0, _iISLectureExampleProduct.defineProjections)(Model);
...
define('ember-app/router', ['exports', 'ember-app/config/environment'], function (exports, _environment) {
  ...
  Router.map(function () {
    ...
    this.route('i-i-s-lecture-example-order-e', { path: 'i-i-s-lecture-example-order-e/:id' });
    this.route('i-i-s-lecture-example-order-e.new', { path: 'i-i-s-lecture-example-order-e/new' });
    this.route('i-i-s-lecture-example-product-l');
    this.route('i-i-s-lecture-example-product-e', { path: 'i-i-s-lecture-example-product-e/:id' });
    this.route('i-i-s-lecture-example-product-e.new', { path: 'i-i-s-lecture-example-product-e/new' });
  });
...
define('ember-app/routes/i-i-s-lecture-example-order-e', ['exports', 'ember-flexberry/routes/edit-form'], function (exports, _editForm) {
  'use strict';
...
define('ember-app/routes/i-i-s-lecture-example-order-e/new', ['exports', 'ember-flexberry/routes/edit-form-new'], function (exports, _editFormNew) {
  'use strict';
  ...
  exports.default = _editFormNew.default.extend({
    modelProjection: 'OrderE',
    modelName: 'i-i-s-lecture-example-order',
    templateName: 'i-i-s-lecture-example-order-e'
  });
});
define('ember-app/routes/i-i-s-lecture-example-order-l', ['exports', 'ember-flexberry/routes/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    ...
    */
    ...
    /**
      Name of model to be used as list's records types.
       @property modelName
      @type String
      @default 'i-i-s-lecture-example-order'
    */
    modelName: 'i-i-s-lecture-example-order',
    ...
    */
    developerUserSettings: Ember.computed(function () {
      return { IISLectureExampleOrderL: {} };
    })
  });
});
define('ember-app/routes/i-i-s-lecture-example-product-e', ['exports', 'ember-flexberry/routes/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    ...
    modelName: 'i-i-s-lecture-example-product'
  });
});
define('ember-app/routes/i-i-s-lecture-example-product-e/new', ['exports', 'ember-flexberry/routes/edit-form-new'], function (exports, _editFormNew) {
  'use strict';
  ...
  exports.default = _editFormNew.default.extend({
    modelProjection: 'ProductE',
    modelName: 'i-i-s-lecture-example-product',
    templateName: 'i-i-s-lecture-example-product-e'
  });
});
define('ember-app/routes/i-i-s-lecture-example-product-l', ['exports', 'ember-flexberry/routes/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    ...
    */
    ...
    /**
      Name of model to be used as list's records types.
       @property modelName
      @type String
      @default 'i-i-s-lecture-example-product'
    */
    modelName: 'i-i-s-lecture-example-product',
    ...
    */
    developerUserSettings: Ember.computed(function () {
      return { IISLectureExampleProductL: {} };
    })
  });
});
...
define('ember-app/serializers/i-i-s-lecture-example-order-item-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-order-item-offline', 'ember-app/serializers/application-offline'], function (exports, _iISLectureExampleOrderItemOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISLectureExampleOrderItemOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-lecture-example-order-item', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-order-item', 'ember-app/serializers/application'], function (exports, _iISLectureExampleOrderItem, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISLectureExampleOrderItem.Serializer, {
    /**
...
define('ember-app/serializers/i-i-s-lecture-example-order-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-order-offline', 'ember-app/serializers/application-offline'], function (exports, _iISLectureExampleOrderOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISLectureExampleOrderOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-lecture-example-order', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-order', 'ember-app/serializers/application'], function (exports, _iISLectureExampleOrder, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISLectureExampleOrder.Serializer, {
    /**
    * Field name where object identifier is kept.
    */
    primaryKey: '__PrimaryKey'
...
define('ember-app/serializers/i-i-s-lecture-example-product-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-product-offline', 'ember-app/serializers/application-offline'], function (exports, _iISLectureExampleProductOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISLectureExampleProductOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-lecture-example-product', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-lecture-example-product', 'ember-app/serializers/application'], function (exports, _iISLectureExampleProduct, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISLectureExampleProduct.Serializer, {
    /**
    * Field name where object identifier is kept.
    */
    primaryKey: '__PrimaryKey'
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        'i-i-s-lecture-example-order-item': 'id,amount,priceWTaxes,totalSum,product,order',
        'i-i-s-lecture-example-order': 'id,paymentDay,shipmentDate,status,totalSum,*orderItem',
        'i-i-s-lecture-example-product': 'id,description,measure,name,price,productCode,weight'
      });
...
define("ember-app/templates/i-i-s-lecture-example-order-e", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "wrVTENnX", "block": "{\"symbols\":[],\"statements\":[[6,\"h3\"],[10,\"class\",\"ui header\"],[8],[1,[26,\"t\",[\"forms.i-i-s-lecture-example-order-e.caption\"],null],false],[9],[0,\"\\n\\n\"],[6,\"form\"],[10,\"class\",\"ui form flexberry-vertical-form\"],[10,\"role\",\"form\"],[8],[0,\"\\n  \"],[1,[26,\"flexberry-error\",null,[[\"error\"],[[22,[\"error\"]]]]],false],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[6,\"div\"],[10,\"class\",\"flexberry-edit-panel\"],[8],[0,\"\\n\"],[4,\"unless\",[[22,[\"readonly\"]]],null,{\"statements\":[[0,\"        \"],[6,\"button\"],[10,\"class\",\"ui button save-button\"],[3,\"action\",[[21,0,[]],\"save\"]],[8],[0,\"\\n          \"],[1,[26,\"t\",[\"forms.edit-form.save-button-text\"],null],false],[0,\"\\n        \"],[9],[0,\"\\n\"],[4,\"unless\",[[22,[\"model\",\"isNew\"]]],null,{\"statements\":[[0,\"          \"],[6,\"button\"],[10,\"class\",\"ui button save-del-button\"],[3,\"action\",[[21,0,[]],\"delete\"]],[8],[0,\"\\n            \"],[1,[26,\"t\",[\"forms.edit-form.delete-button-text\"],null],false],[0,\"\\n          \"],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[0,\"      \"],[6,\"button\"],[10,\"class\",\"ui button close-button\"],[3,\"action\",[[21,0,[]],\"close\"]],[8],[0,\"\\n        \"],[1,[26,\"t\",[\"forms.edit-form.close-button-text\"],null],false],[0,\"\\n      \"],[9],[0,\"\\n    \"],[9],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field flexberry-validationsummary-container\"],[8],[0,\"\\n    \"],[6,\"div\"],[10,\"class\",\"sixteen wide\"],[8],[0,\"\\n      \"],[1,[26,\"flexberry-validationsummary\",null,[[\"errors\"],[[26,\"get\",[[22,[\"validationObject\",\"validations\"]],\"messages\"],null]]]],false],[0,\"\\n    \"],[9],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[10,\"data-test-i-i-s-lecture-example-order-e-status\",\"true\"],[8],[0,\"\\n    \"],[6,\"label\"],[8],[1,[26,\"t\",[\"forms.i-i-s-lecture-example-order-e.status-caption\"],null],false],[9],[0,\"\\n    \"],[1,[26,\"flexberry-dropdown\",null,[[\"items\",\"value\",\"class\",\"readonly\"],[[26,\"flexberry-enum\",[\"i-i-s-lecture-example-order-status\"],null],[22,[\"model\",\"status\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"status\"],null],\"isInvalid\"],null],\"error\"],null],[22,[\"readonly\"]]]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"status\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[6,\"label\"],[8],[1,[26,\"t\",[\"forms.i-i-s-lecture-example-order-e.shipmentDate-caption\"],null],false],[9],[0,\"\\n    \"],[1,[26,\"flexberry-simpledatetime\",null,[[\"type\",\"readonly\",\"value\",\"class\",\"data-test-i-i-s-lecture-example-order-e-shipmentDate\"],[\"date\",[22,[\"readonly\"]],[22,[\"model\",\"shipmentDate\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"shipmentDate\"],null],\"isInvalid\"],null],\"error\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"shipmentDate\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[6,\"label\"],[8],[1,[26,\"t\",[\"forms.i-i-s-lecture-example-order-e.paymentDay-caption\"],null],false],[9],[0,\"\\n    \"],[1,[26,\"flexberry-simpledatetime\",null,[[\"type\",\"readonly\",\"value\",\"class\",\"data-test-i-i-s-lecture-example-order-e-paymentDay\"],[\"date\",[22,[\"readonly\"]],[22,[\"model\",\"paymentDay\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"paymentDay\"],null],\"isInvalid\"],null],\"error\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"paymentDay\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[1,[26,\"flexberry-field\",null,[[\"readonly\",\"value\",\"class\",\"label\",\"data-test-i-i-s-lecture-example-order-e-totalSum\"],[[22,[\"readonly\"]],[22,[\"model\",\"totalSum\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"totalSum\"],null],\"isInvalid\"],null],\"error\"],null],[26,\"t\",[\"forms.i-i-s-lecture-example-order-e.totalSum-caption\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"totalSum\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[6,\"label\"],[8],[1,[26,\"t\",[\"forms.i-i-s-lecture-example-order-e.orderItem-caption\"],null],false],[9],[0,\"\\n    \"],[1,[26,\"flexberry-groupedit\",null,[[\"componentName\",\"mainModelProjection\",\"modelProjection\",\"content\",\"readonly\",\"orderable\",\"class\",\"data-test-i-i-s-lecture-example-order-e-orderItem\"],[\"orderItemGroupEdit\",[22,[\"modelProjection\"]],[22,[\"modelProjection\",\"attributes\",\"orderItem\"]],[22,[\"model\",\"orderItem\"]],[22,[\"readonly\"]],false,[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"orderItem\"],null],\"isInvalid\"],null],\"error\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"orderItem\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ember-app/templates/i-i-s-lecture-example-order-e.hbs" } });
});
define("ember-app/templates/i-i-s-lecture-example-order-l", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "4NzBZg5D", "block": "{\"symbols\":[],\"statements\":[[1,[26,\"flexberry-error\",null,[[\"error\"],[[22,[\"error\"]]]]],false],[0,\"\\n\"],[6,\"h3\"],[8],[1,[26,\"t\",[\"forms.i-i-s-lecture-example-order-l.caption\"],null],false],[9],[0,\"\\n\"],[6,\"div\"],[10,\"class\",\"row\"],[8],[0,\"\\n  \"],[1,[26,\"flexberry-objectlistview\",null,[[\"modelName\",\"modelProjection\",\"editFormRoute\",\"content\",\"createNewButton\",\"refreshButton\",\"sorting\",\"orderable\",\"showCheckBoxInRow\",\"sortByColumn\",\"addColumnToSorting\",\"beforeDeleteAllRecords\",\"pages\",\"perPageValue\",\"perPageValues\",\"recordsTotalCount\",\"hasPreviousPage\",\"hasNextPage\",\"previousPage\",\"gotoPage\",\"nextPage\",\"componentName\",\"deleteButton\",\"exportExcelButton\",\"enableFilters\",\"filters\",\"filterButton\",\"showDeleteButtonInRow\",\"showPrototypeButtonInRow\",\"showEditButtonInRow\",\"showFiltersInModal\",\"applyFilters\",\"resetFilters\",\"filterByAnyMatch\"],[[22,[\"modelName\"]],[22,[\"modelProjection\"]],[22,[\"editFormRoute\"]],[22,[\"model\"]],true,true,[22,[\"computedSorting\"]],true,true,[26,\"action\",[[21,0,[]],\"sortByColumn\"],null],[26,\"action\",[[21,0,[]],\"addColumnToSorting\"],null],[26,\"action\",[[21,0,[]],\"beforeDeleteAllRecords\"],null],[22,[\"pages\"]],[22,[\"perPageValue\"]],[22,[\"perPageValues\"]],[22,[\"recordsTotalCount\"]],[22,[\"hasPreviousPage\"]],[22,[\"hasNextPage\"]],[26,\"action\",[[21,0,[]],\"previousPage\"],null],[26,\"action\",[[21,0,[]],\"gotoPage\"],null],[26,\"action\",[[21,0,[]],\"nextPage\"],null],\"IISLectureExampleOrderL\",true,true,true,[22,[\"filters\"]],true,true,true,true,true,[26,\"action\",[[21,0,[]],\"applyFilters\"],null],[26,\"action\",[[21,0,[]],\"resetFilters\"],null],[26,\"action\",[[21,0,[]],\"filterByAnyMatch\"],null]]]],false],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ember-app/templates/i-i-s-lecture-example-order-l.hbs" } });
});
define("ember-app/templates/i-i-s-lecture-example-product-e", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "dy5FFCSq", "block": "{\"symbols\":[],\"statements\":[[6,\"h3\"],[10,\"class\",\"ui header\"],[8],[1,[26,\"t\",[\"forms.i-i-s-lecture-example-product-e.caption\"],null],false],[9],[0,\"\\n\\n\"],[6,\"form\"],[10,\"class\",\"ui form flexberry-vertical-form\"],[10,\"role\",\"form\"],[8],[0,\"\\n  \"],[1,[26,\"flexberry-error\",null,[[\"error\"],[[22,[\"error\"]]]]],false],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[6,\"div\"],[10,\"class\",\"flexberry-edit-panel\"],[8],[0,\"\\n\"],[4,\"unless\",[[22,[\"readonly\"]]],null,{\"statements\":[[0,\"        \"],[6,\"button\"],[10,\"class\",\"ui button save-button\"],[3,\"action\",[[21,0,[]],\"save\"]],[8],[0,\"\\n          \"],[1,[26,\"t\",[\"forms.edit-form.save-button-text\"],null],false],[0,\"\\n        \"],[9],[0,\"\\n\"],[4,\"unless\",[[22,[\"model\",\"isNew\"]]],null,{\"statements\":[[0,\"          \"],[6,\"button\"],[10,\"class\",\"ui button save-del-button\"],[3,\"action\",[[21,0,[]],\"delete\"]],[8],[0,\"\\n            \"],[1,[26,\"t\",[\"forms.edit-form.delete-button-text\"],null],false],[0,\"\\n          \"],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[0,\"      \"],[6,\"button\"],[10,\"class\",\"ui button close-button\"],[3,\"action\",[[21,0,[]],\"close\"]],[8],[0,\"\\n        \"],[1,[26,\"t\",[\"forms.edit-form.close-button-text\"],null],false],[0,\"\\n      \"],[9],[0,\"\\n    \"],[9],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field flexberry-validationsummary-container\"],[8],[0,\"\\n    \"],[6,\"div\"],[10,\"class\",\"sixteen wide\"],[8],[0,\"\\n      \"],[1,[26,\"flexberry-validationsummary\",null,[[\"errors\"],[[26,\"get\",[[22,[\"validationObject\",\"validations\"]],\"messages\"],null]]]],false],[0,\"\\n    \"],[9],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[1,[26,\"flexberry-field\",null,[[\"readonly\",\"value\",\"class\",\"label\",\"data-test-i-i-s-lecture-example-product-e-productCode\"],[[22,[\"readonly\"]],[22,[\"model\",\"productCode\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"productCode\"],null],\"isInvalid\"],null],\"error\"],null],[26,\"t\",[\"forms.i-i-s-lecture-example-product-e.productCode-caption\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"productCode\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[1,[26,\"flexberry-field\",null,[[\"readonly\",\"value\",\"class\",\"label\",\"data-test-i-i-s-lecture-example-product-e-name\"],[[22,[\"readonly\"]],[22,[\"model\",\"name\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"name\"],null],\"isInvalid\"],null],\"error\"],null],[26,\"t\",[\"forms.i-i-s-lecture-example-product-e.name-caption\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"name\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[1,[26,\"flexberry-field\",null,[[\"readonly\",\"value\",\"class\",\"label\",\"data-test-i-i-s-lecture-example-product-e-measure\"],[[22,[\"readonly\"]],[22,[\"model\",\"measure\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"measure\"],null],\"isInvalid\"],null],\"error\"],null],[26,\"t\",[\"forms.i-i-s-lecture-example-product-e.measure-caption\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"measure\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[1,[26,\"flexberry-field\",null,[[\"readonly\",\"value\",\"class\",\"label\",\"data-test-i-i-s-lecture-example-product-e-description\"],[[22,[\"readonly\"]],[22,[\"model\",\"description\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"description\"],null],\"isInvalid\"],null],\"error\"],null],[26,\"t\",[\"forms.i-i-s-lecture-example-product-e.description-caption\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"description\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[1,[26,\"flexberry-field\",null,[[\"readonly\",\"value\",\"class\",\"label\",\"data-test-i-i-s-lecture-example-product-e-price\"],[[22,[\"readonly\"]],[22,[\"model\",\"price\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"price\"],null],\"isInvalid\"],null],\"error\"],null],[26,\"t\",[\"forms.i-i-s-lecture-example-product-e.price-caption\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"price\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[1,[26,\"flexberry-field\",null,[[\"readonly\",\"value\",\"class\",\"label\",\"data-test-i-i-s-lecture-example-product-e-weight\"],[[22,[\"readonly\"]],[22,[\"model\",\"weight\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"weight\"],null],\"isInvalid\"],null],\"error\"],null],[26,\"t\",[\"forms.i-i-s-lecture-example-product-e.weight-caption\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationModel\",\"validations\",\"attrs\"]],\"weight\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ember-app/templates/i-i-s-lecture-example-product-e.hbs" } });
});
define("ember-app/templates/i-i-s-lecture-example-product-l", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "WzNlcH/Y", "block": "{\"symbols\":[],\"statements\":[[1,[26,\"flexberry-error\",null,[[\"error\"],[[22,[\"error\"]]]]],false],[0,\"\\n\"],[6,\"h3\"],[8],[1,[26,\"t\",[\"forms.i-i-s-lecture-example-product-l.caption\"],null],false],[9],[0,\"\\n\"],[6,\"div\"],[10,\"class\",\"row\"],[8],[0,\"\\n  \"],[1,[26,\"flexberry-objectlistview\",null,[[\"modelName\",\"modelProjection\",\"editFormRoute\",\"content\",\"createNewButton\",\"refreshButton\",\"sorting\",\"orderable\",\"showCheckBoxInRow\",\"sortByColumn\",\"addColumnToSorting\",\"beforeDeleteAllRecords\",\"pages\",\"perPageValue\",\"perPageValues\",\"recordsTotalCount\",\"hasPreviousPage\",\"hasNextPage\",\"previousPage\",\"gotoPage\",\"nextPage\",\"componentName\",\"deleteButton\",\"exportExcelButton\",\"enableFilters\",\"filters\",\"filterButton\",\"showDeleteButtonInRow\",\"showPrototypeButtonInRow\",\"showEditButtonInRow\",\"showFiltersInModal\",\"applyFilters\",\"resetFilters\",\"filterByAnyMatch\"],[[22,[\"modelName\"]],[22,[\"modelProjection\"]],[22,[\"editFormRoute\"]],[22,[\"model\"]],true,true,[22,[\"computedSorting\"]],true,true,[26,\"action\",[[21,0,[]],\"sortByColumn\"],null],[26,\"action\",[[21,0,[]],\"addColumnToSorting\"],null],[26,\"action\",[[21,0,[]],\"beforeDeleteAllRecords\"],null],[22,[\"pages\"]],[22,[\"perPageValue\"]],[22,[\"perPageValues\"]],[22,[\"recordsTotalCount\"]],[22,[\"hasPreviousPage\"]],[22,[\"hasNextPage\"]],[26,\"action\",[[21,0,[]],\"previousPage\"],null],[26,\"action\",[[21,0,[]],\"gotoPage\"],null],[26,\"action\",[[21,0,[]],\"nextPage\"],null],\"IISLectureExampleProductL\",true,true,true,[22,[\"filters\"]],true,true,true,true,true,[26,\"action\",[[21,0,[]],\"applyFilters\"],null],[26,\"action\",[[21,0,[]],\"resetFilters\"],null],[26,\"action\",[[21,0,[]],\"filterByAnyMatch\"],null]]]],false],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ember-app/templates/i-i-s-lecture-example-product-l.hbs" } });
});
...
define('ember-app/transforms/i-i-s-lecture-example-order-status', ['exports', 'ember-flexberry-data/transforms/flexberry-enum', 'ember-app/enums/i-i-s-lecture-example-order-status'], function (exports, _flexberryEnum, _iISLectureExampleOrderStatus) {
  'use strict';
  ...
  exports.default = _flexberryEnum.default.extend({
    enum: _iISLectureExampleOrderStatus.default,
